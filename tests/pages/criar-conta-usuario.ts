...
export class CreateNewCustomerAccount {
    ...
    constructor(page: Page) {
        ...
        this.passwordStrengthMeter = this.page.getByTestId('password-strength-meter');
    };
    ...
    async fillPasswordField(password :string){
        ...
        await this.fieldPassword.press('Enter');
    }

    async verifyPassword(message :string){
        expect(this.passwordStrengthMeter.filter({hasText :message})).toBeTruthy();
    }
};